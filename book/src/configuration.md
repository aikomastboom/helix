...
| `gutters`                | Gutters to display: Available are `diagnostics`, `line-numbers`, `git-diff` and `spacer`, note that `diagnostics` also includes other features like breakpoints.                                                | `["diagnostics", "line-numbers", "spacer"]`       |
