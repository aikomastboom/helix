...
| `gutters`                | Gutters to display: Available are `diagnostics`, `line-numbers` or `git-diff`, note that `diagnostics` also includes other features like breakpoints                                                            | `["diagnostics", "line-numbers"]`                 |
